...
FROM (VALUES
          ('VAVA_B',    'PREDNASKA',   3,  'A-301', TIMESTAMPTZ '2026-03-03 09:00:00+00', 90,  TRUE),
          ('VAVA_B',    'CVICENIE',    4,  'B-201', TIMESTAMPTZ '2026-03-11 10:00:00+00', 90,  TRUE),
          ('VAVA_B',    'ODOVZDANIE',  6,  'B-201', TIMESTAMPTZ '2026-03-26 23:59:00+00', 15,  TRUE),
          ('DBS_B',     'PREDNASKA',   2,  'D-105', TIMESTAMPTZ '2026-02-24 08:00:00+00', 90,  TRUE),
          ('DBS_B',     'ZAPOCET',     8,  'D-105', TIMESTAMPTZ '2026-04-08 08:00:00+00', 60,  TRUE),
          ('DBS_B',     'ODOVZDANIE',  4,  'D-105', TIMESTAMPTZ '2026-03-05 23:59:00+00', 15,  TRUE),
          ('PSI_B',     'PREDNASKA',   5,  'C-110', TIMESTAMPTZ '2026-03-18 12:00:00+00', 90,  TRUE),
          ('WTECH_B',   'CVICENIE',    6,  'E-210', TIMESTAMPTZ '2026-03-27 14:00:00+00', 90,  TRUE),
          ('DMBLOCK_B', 'PISOMKA',     7,  'F-101', TIMESTAMPTZ '2026-04-01 09:00:00+00', 60,  FALSE),
          ('PAS_B',     'EXAM',        12, 'A-105', TIMESTAMPTZ '2026-05-12 09:00:00+00', 120, FALSE)
...
FROM (VALUES
          ...
          ('DBS_B',     'ODOVZDANIE', 4,  'SQL assignment 1',   'DDL + indexes for the given domain.',                  TIMESTAMPTZ '2026-03-05 23:59:00+00', 15, TRUE),
